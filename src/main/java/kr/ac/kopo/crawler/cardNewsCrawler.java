...
//크롤러
	...
	public static void main(String[] args) {
		...
		String url = "http://www.bok.or.kr/portal/bbs/B0000273/list.do?menuNo=201037"; // 크롤링할 url지정
		...
		Iterator<Element> ie1 = element.select("[class=col m3 s6 x12]").iterator();
	

		// Iterator<Element> ie2 = element.select("td.number").iterator();
		// Iterator<Element> ie3 = element.select("td.no").iterator();
		
		Iterator<Element> ie2 = element.select("a").iterator();
