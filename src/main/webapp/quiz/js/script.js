...
quit_quiz.onclick = ()=>{
    window.location.href = '/HN-Project/member/mbti' //reload the current window
}
...
function showResult(){
    ...
    if (userScore > 10){ // if user scored more than 6
        //creating a new span tag and passing the user score number and total question number
        let scoreTag = '<span>와우! 대단해요🎉 <p>'+ questions.length  +'</p> 문제 중<p>'+ userScore +'</p>를 맞췄어요!</span>';
